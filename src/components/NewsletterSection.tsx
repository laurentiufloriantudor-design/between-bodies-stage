...
const NewsletterSection = ({ variant = "dark" }: NewsletterSectionProps) => {
  ...
  return (
    <section id="newsletter" ref={ref} className="relative py-24 md:py-32 px-6 md:px-12 overflow-hidden" style={{ backgroundColor: "#162836" }}>
      <div className="absolute top-[-60px] right-[-40px] w-[280px] h-[280px] rounded-full opacity-10 animate-drift-slow" style={{ backgroundColor: "#68AEB3" }} />
      <div className="absolute bottom-[-40px] left-[5%] w-[200px] h-[200px] opacity-8 animate-drift-slow" style={{ backgroundColor: "#E1664D", opacity: 0.08, borderRadius: "60% 40% 50% 50% / 50% 60% 40% 50%" }} />
      <div className="absolute top-[40%] left-[60%] w-[120px] h-[120px] opacity-6 animate-drift-slow" style={{ backgroundColor: "#68AEB3", opacity: 0.06, borderRadius: "40% 60% 55% 45% / 55% 45% 60% 40%" }} />
